-- Add cct_processed column to customers table
ALTER TABLE public.customers
ADD COLUMN IF NOT EXISTS cct_processed boolean DEFAULT false;

-- Update get_cct_customers function to include the new column
