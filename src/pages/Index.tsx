...
import { getStats, getCustomerCount, getStatsHistory, getSettings, Stats, StatsHistory, Settings, MAX_HISTORY_RECORDS, supabase } from '@/lib/supabase';
      ...
      <div className="flex-1 ml-[190px] p-8 flex flex-col">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <MetricCard 
            ...
            targetValue={settings?.target_all}
            showStatus={true}
          >
            <StatisticChart 
          ...
          <MetricCard 
            ...
            targetValue={settings?.target_top}
            showStatus={false}
          >
            <StatisticChart 
              data={topChartData} 
          ...
          <MetricCard 
            ...
            targetValue={settings?.target_invoice}
            showStatus={false}
          >
            <StatisticChart 
